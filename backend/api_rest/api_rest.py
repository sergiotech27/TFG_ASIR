...
def compare_faces_route():
    try:
        ...
        if os.path.exists("/var/www/html/api_rest/temp_image.jpg"):
            os.remove("/var/www/html/api_rest/temp_image.jpg")
        ...
        temp_image.save("/var/www/html/api_rest/temp_image.jpg")  # Guardar la imagen temporal para su uso en comparación

        result = compare_faces(user_image_path, "/var/www/html/api_rest/temp_image.jpg")
